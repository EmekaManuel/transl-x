...
const AiChat = () => {
  ...
  const translate = async () => {
    ...
    const apiKey = "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";
    const url =
  ...
  return (
    <>
      <div>
        ...
        <aside
          id="default-sidebar"
          className="fixed top-0 hidden md:flex left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <h1 className="text-2xl space-y-2 p-2 text-white font-bold">Transl-X AI</h1>
        ...
        <div className="p-4 sm:ml-64 flex flex-col space-y-10 justify-between ">
          {/* //div 1 */}
          <div className="p-3 border-2  border-gray-300 border-dashed rounded-lg dark:border-gray-700">
          ...
          <div className="p-4 relative border-2 border-gray-300 flex   rounded-lg bg-green-100">
            ...
            <p className="pt-7">
              {loading ? <BeatLoader size={12} color={"blue"} /> : translation}
            </p>
          ...
          <div className="p-4 space-y-4 flex flex-col gap-3 items-center justify-center  ">
              ...
              <div className="flex justify-center items-center flex-col">
                <div className=" relative w-full ">
                  ...
                  <div className="absolute bottom-2 right-2 text-gray-400 text-xs">
                    <span>{formData.text.length}</span>/100
                  </div>
                </div>
            ...
            <button
              ...
              className="bg-gray-200 border relative border-black w-5/12 max-w-screen-md hover:bg-black hover:text-white text-black font-mono py-[8px] px-4 rounded"
            >
              Translate
            </button>
            <p className="underline "> <a href="/">back to homepage</a></p>
          </div>
        </div>
